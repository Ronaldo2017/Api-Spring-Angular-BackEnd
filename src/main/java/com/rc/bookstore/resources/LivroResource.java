package com.rc.bookstore.resources;
...
import com.rc.bookstore.dto.LivroDTO;
import com.rc.bookstore.services.LivroService;
...
public class LivroResource {
	...
	@PutMapping(value = "/{id}")//atualiza tudas as informações
	public ResponseEntity<Livro> update(@PathVariable Integer id, @Valid @RequestBody Livro obj){
		Livro newObj = livroService.update(id, obj);
		return ResponseEntity.ok().body(newObj);
	}
	
	@PatchMapping(value = "/{id}")//atualiza somente uma das informações
